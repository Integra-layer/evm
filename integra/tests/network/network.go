...
import (
	...
	evmconfig "github.com/integra/integra/config"
...
func DefaultConfig() Config {
	...
	tempApp := integra.NewExampleApp(log.NewNopLogger(), dbm.NewMemDB(), nil, true, simutils.NewAppOptionsWithFlagHome(dir), baseapp.SetChainID(chainID))
